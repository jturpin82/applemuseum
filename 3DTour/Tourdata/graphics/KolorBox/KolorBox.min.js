...
s = parseFloat(ktools.Url.getParam(d.e(), "height")) ? ktools.Url.getParam(d.e(), "height") : a.iframe_default_height, v = ja(H, I), t = g; "iframe" === d.f() && (t = u); var l = K(v.width - h, v.height - h, j, s, t, u), d = l.width + h, n = l.height + h, m = document.createElement("iframe"); m.id = "kolorBoxID_" + da; m.className = "displayedItem"; ktools.Device.isTouch() || (v = b.replace(/&amp;/g, "&"), m.setAttribute("src", '/3DTour/'+v)); m.setAttribute("allowfullscreen", ""); m.setAttribute("mozallowfullscreen", ""); m.setAttribute("webkitallowfullscreen", ""); m.setAttribute("frameborder", "0"); m.setAttribute("allowtransparency", "true"); ktools.Device.isTouch() ? m.setAttribute("style", "visibility: visible;") : m.setAttribute("style", "visibility: hidden;"); m.setAttribute("scrolling", a.iframe_scrolling); var p; ktools.Device.isTouch() || (p = window.setInterval(function() { if (window.frames[m.id]) { window.clearInterval(p); jQuery(m).css("visibility", "visible");
